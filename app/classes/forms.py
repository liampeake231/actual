...
class ReviewForm(FlaskForm):
    name = SelectField('Thrift Store Name',choices=[("Goodwill","Out of the Closet"),("Thrift Town","Community Thrift"), ("American Cancer Society Discovery Shop", "Goodwill Store & Donation Center"), ("Salvation Army")])
